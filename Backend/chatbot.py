...
app = FastAPI(title="MedLink AI Chatbot", description="AI-powered medical symptom checker and health assistant")
...
def generate_medical_response(message, context="", user_profile=None):
    ...
    try:
        ...
        system_prompt = """You are MedLink AI, an advanced medical assistant specialized in symptom analysis and health guidance. 
...
Respond naturally and professionally without referencing the knowledge base directly."""
        ...
        # Prepare payload
        payload = {
            "model": "openai/gpt-oss-20b",  # Using larger model for better medical responses
            "messages": [
                {
                    "role": "system",
...
async def health_check():
    """
    Health check endpoint for the MedLink AI service
    """
    return {
        "status": "healthy",
        "service": "MedLink AI Chatbot",
        "version": "1.0.0",
        "timestamp": datetime.now().isoformat()
    }
...
async def root():
    ...
    """
    return {
        "message": "Welcome to MedLink AI - Your AI-powered medical assistant",
        "version": "1.0.0",
        "endpoints": {
...
if __name__ == "__main__":
    import uvicorn
    print("Starting MedLink AI Chatbot Service...")
